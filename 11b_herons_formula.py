...
# Heron's formula states the area of a triangle is 
# sqrt[s(s−a)(s−b)(s−c)]
# where a, b and c are the lengths of the sides of the triangle 
# and s=(1/2)(a+b+c) is the semi-perimeter of the triangle. 
# Given the variables x0, y0, x1,y1, x2, and y2, write a Python 
# program that computes a variable area whose value is the area 
